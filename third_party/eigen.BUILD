# Vendored from the Bazel Central Registry's overlay for the eigen module
# (https://bcr.bazel.build/modules/eigen/5.0.1.bcr.1/overlay/BUILD.bazel).
# Upstream Eigen ships no BUILD file, so bzlmod gets this from the registry
# and the WORKSPACE path needs its own copy.  Keep the two in sync.
