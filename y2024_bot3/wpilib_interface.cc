...
#include "frc/wpilib/logging_generated.h"
...
constexpr double kMaxFastEncoderPulsesPerSecond = std::max({
    ...
    // TODO: Add kMaxArmEncoderPulsesPerSecond
});
...
class SensorReader : public ::frc::wpilib::SensorReader {
 ...
 private:
  ...
  frc::wpilib::DMAAbsoluteEncoderAndPotentiometer arm_sensors_;
...
class WPILibRobot : public ::frc::wpilib::WPILibRobotBase {
 public:
  ...
  void Run() override {
    ...
    frc::constants::WaitForConstants<y2024_bot3::Constants>(
        &config.message());
    ...
    frc::wpilib::GenericCANWriter<control_loops::superstructure::Output>
    ...
    can_output_event_loop.MakeWatcher(
        "/roborio", [&can_superstructure_writer](
                        const frc::CANConfiguration &configuration) {
