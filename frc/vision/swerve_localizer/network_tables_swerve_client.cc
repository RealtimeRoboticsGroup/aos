...
ABSL_FLAG(std::string, autonomous_topic, "/AdvantageKit/DriverStation/Autonomous", "");
ABSL_FLAG(std::string, alliance_station_topic, "/AdvantageKit/DriverStation/AllianceStation", "");
ABSL_FLAG(std::string, dsattached_topic, "/AdvantageKit/DriverStation/DSAttached", "");
ABSL_FLAG(std::string, emergency_stop_topic, "/AdvantageKit/DriverStation/EmergencyStop", "");
ABSL_FLAG(std::string, enabled_topic, "/AdvantageKit/DriverStation/Enabled", "");
ABSL_FLAG(std::string, event_name_topic, "/AdvantageKit/DriverStation/EventName", "");
ABSL_FLAG(std::string, fms_attached_topic, "/AdvantageKit/DriverStation/FMSAttached", "");
ABSL_FLAG(std::string, match_number_topic, "/AdvantageKit/DriverStation/MatchNumber", "");
ABSL_FLAG(std::string, match_time_topic, "/AdvantageKit/DriverStation/MatchTime", "");
ABSL_FLAG(std::string, match_type_topic, "/AdvantageKit/DriverStation/MatchType", "");
ABSL_FLAG(std::string, replay_number_topic, "/AdvantageKit/DriverStation/ReplayNumber", "");
ABSL_FLAG(std::string, test_topic, "/AdvantageKit/DriverStation/Test", "");
ABSL_FLAG(std::string, battery_voltage_topic, "/AdvantageKit/SystemStats/BatteryVoltage", "");
...
int Main() {
...

  {
    ...
    chassis_speed_topic =
        instance.GetStructTopic<frc::ChassisSpeeds>(absl::GetFlag(FLAGS_chassis_speed_topic));
    ...
    test_topic =
        instance.GetBooleanTopic(absl::GetFlag(FLAGS_test_topic));
