...
```
pi[83] orin-4646-1 ~
$ intrinsics_calibration --base_intrinsics bin/base_intrinsics/calibration_orin1-4646-0_cam-25-07_2025-02-18_13-23-39.json --channel /camera0/gray --camera_id [CAMERA ID] --grayscale --poll_images --image_save_path /tmp/[CAMERA ID]/ --twenty_inch_large_board
