...
int Main() {
  ...
  // LOG(INFO) << "Dtx: " << (orientation0 * Eigen::Vector3d(1.0, 0.0, 0.0) -
  // orientation0 * Eigen::Vector3d(0.0, 0.0, 0.0)).transpose(); LOG(INFO) <<
  // "Dty: " << (orientation0 * Eigen::Vector3d(0.0, 1.0, 0.0) - orientation0
  // * Eigen::Vector3d(0.0, 0.0, 0.0)).transpose(); LOG(INFO) << "Dtz: " <<
  // (orientation0 * Eigen::Vector3d(0.0, 0.0, 1.0) - orientation0 *
  // Eigen::Vector3d(0.0, 0.0, 0.0)).transpose();
