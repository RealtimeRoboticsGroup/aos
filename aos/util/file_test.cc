...
TEST(FileTest, SyncDirectory) {
  ...
  const ::std::string new_dir =
      tmp_dir + "/sync_dir_test/";  // Add trailing slash
...
TEST(FileTest, MkdirPIfSpace) {
  ...
  const ::std::string base_dir =
      tmp_dir + "/mkdir_p_if_space/";  // Add trailing slash
  const ::std::string new_dir_sync =
      base_dir + "sync/a/b/c/";  // Add trailing slash
  const ::std::string new_dir_nosync =
      base_dir + "nosync/a/b/c/";  // Add trailing slash
